...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setNavigationItemSelectedListener(item->
        {
           ...
           if(item.getItemId()==R.id.it_fechar){
               finish();
           }
    ...
    public void cadastrarMusicas(Musica musica){
        //caso musica seja null, suponha a inserção
        int musicaId;
        if(musica != null)
        ...
        //cria o fragment passando o ID
        NovaMusicaFragment novaMusicaFragment = NovaMusicaFragment.newInstance(musicaId);
